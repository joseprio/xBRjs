...
const _xBRjs$xbr2x = xBRjs['xbr2x'];
const _xBRjs$xbr3x = xBRjs['xbr3x'];
const _xBRjs$xbr4x = xBRjs['xbr4x'];

export {
    _xBRjs$xbr2x as xbr2x,
    _xBRjs$xbr3x as xbr3x,
    _xBRjs$xbr4x as xbr4x
}